import{b as p,x as m,r as d,i as b,e as c,n as l}from"./reset.css-C8x1Zwsv.js";var f=Object.defineProperty,n=(h,s,t,o)=>{for(var e=void 0,a=h.length-1,u;a>=0;a--)(u=h[a])&&(e=u(s,t,e)||e);return e&&f(s,t,e),e};const i=class i extends p{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password)}render(){return m`
            <form
        ...
        `];let r=i;n([c()],r.prototype,"formData");n([l()],r.prototype,"api");n([l()],r.prototype,"redirect");n([c()],r.prototype,"error");export{r as L};
