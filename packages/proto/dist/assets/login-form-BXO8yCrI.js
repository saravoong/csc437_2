import{a as p,x as m,r as d,i as b,c as u,n as l}from"./state-LPCHAKqD.js";var f=Object.defineProperty,n=(h,s,t,o)=>{for(var e=void 0,a=h.length-1,c;a>=0;a--)(c=h[a])&&(e=c(s,t,e)||e);return e&&f(s,t,e),e};const i=class i extends p{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password)}render(){return m`
            <form
