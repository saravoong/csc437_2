import{a as m,O as y,x as c,r as f,i as b,n as p,c as d,d as $}from"./state-LPCHAKqD.js";import{p as C,t as _}from"./tokens.css-CLyr5EUn.js";import{S as g}from"./story-CWT6gx5K.js";var v=Object.defineProperty,a=(l,s,e,o)=>{for(var t=void 0,i=l.length-1,h;i>=0;i--)(h=l[i])&&(t=h(s,e,t)||t);return t&&v(s,e,t),t};const u=class u extends m{constructor(){super(...arguments),this.chapters=[],this.storyTitle="",this.chapterNumber=0,this._authObserver=new y(this,"episode:auth")}render(){if(!this.selectedChapter)return c`
